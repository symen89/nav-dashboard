...
// Portfolio holdings verwijderd - alleen beschikbaar in factsheet
// Percentages calculated based on USD values at time of snapshot
// Portfolio holdings verwijderd - alleen in factsheet
// Portfolio holdings verwijderd van dashboard
