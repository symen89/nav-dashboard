...
const PORTFOLIO_HOLDINGS = [
  { symbol: 'WETH', name: 'Wrapped Ether', balance: 55.49, img: 'https://images.octav.fi/chains/ethereum_icon.svg' },
  { symbol: 'WBTC', name: 'Wrapped Bitcoin', balance: 1.003, img: 'https://images.octav.fi/tokens/small/0x2260fac5e5542a773aa44fbcfedf7c193bc2c599_small_icon.png' },
  { symbol: 'LINK', name: 'Chainlink', balance: 2275.98, img: 'https://images.octav.fi/tokens/small/0x514910771af9ca656af840dff83e8264ecf986ca_small_icon.png' },
  { symbol: 'POL', name: 'Polygon', balance: 20168.28, img: 'https://images.octav.fi/chains/polygon_icon.svg' },
  { symbol: 'WTAO', name: 'Wrapped TAO', balance: 53.00, img: 'https://images.octav.fi/tokens/small/wtao_logo_758042fd-ead0-45a2-af1b-bf0c20ae2fbc.png' },
  { symbol: 'MLN', name: 'Enzyme', balance: 56.43, img: 'https://images.octav.fi/tokens/small/0xec67005c4e498ec7f55e092bd1d35cbc47c91892_small_icon.png' },
  { symbol: 'EUROC', name: 'Euro Coin', balance: 1543.07, img: 'https://images.octav.fi/tokens/small/0x1abaea1f7c830bd89acc67ec4af516284b1bc33c_small_icon.png' },
];
  ...
  return (
    <div className="p-4 min-h-screen text-white" style={{ background: '#0f151b' }}>
      <div className="max-w-6xl mx-auto">
        ...
        {/* Portfolio Holdings */}
        <div className="bg-[#161d26] p-4 rounded-xl border border-[#2a3441] mt-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
            {PORTFOLIO_HOLDINGS.map((asset) => (
              <div key={asset.symbol} className="bg-[#1e2731] p-3 rounded-lg border border-[#2a3441] text-center">
                ...
                <p className="text-xs text-[#8b95a5]">{asset.balance.toLocaleString('nl-NL', { maximumFractionDigits: 2 })}</p>
              </div>
            ))}
          </div>
        </div>
